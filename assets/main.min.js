...
var barbajs=require("barba.js"),settings=require("modules/settings"),barba=module.exports={init:function(){barbajs.Pjax.start(),console.log("barba init"),barbajs.Dispatcher.on("newPageReady",function(e,t,a){barba.initModules(),barba.clearTimers()});var e=barbajs.BaseTransition.extend({start:function(){Promise.all([this.newContainerLoading,this.fadeOut()]).then(this.fadeIn.bind(this))},fadeOut:function(){return $("body").addClass("scrolling"),$(this.oldContainer).animate({opacity:0},200).promise()},fadeIn:function(){var e=this,t=$(this.newContainer);$(this.oldContainer).hide(),settings.page=t.find(".main").data("template"),console.log("settings.page = "+settings.page),"project"!=settings.page&&"home"!=settings.page?$("header").removeClass("hero-menu"):$("header").addClass("hero-menu"),barba.setBodyClass(),$("body").scrollTop(0),$("body").removeClass("scrolling"),t.css({visibility:"visible",opacity:0}),t.animate({opacity:1},200,function(){e.done()})}});barbajs.Pjax.getTransition=function(){return e}},clearTimers:function(){for(var e=0;e<settings.timers.length;e++)clearTimeout(settings.timers[e])},setBodyClass:function(){var e=$(".page-template").last().data("template");console.log($(".page-template")),$("body").removeClass().addClass(e)},initModules:function(){for(var e=$("#barba-wrapper").find("[data-module-init]"),t=0;t<e.length;t++)for(var a,s=e[t],i=s.getAttribute("data-module-init").split(" "),n=0;n<i.length;n++){try{a=require("modules/"+i[n])}catch(o){a=!1,console.log(i[n]+" module does not exist.")}a&&new a(s)}}};
},{"barba.js":1,"modules/settings":"modules/settings"}],"modules/body":[function(require,module,exports){
var settings=require("modules/settings"),throttle=require("modules/throttle"),menu=require("modules/menu"),footer=require("modules/footer"),barba=require("modules/barba");module.exports=function(o){function e(){barba.init(),menu.init(),footer.init(),console.log("body init"),s.on("resize",r)}function n(){$("body").addClass("noTransition")}function i(){$("body").removeClass("noTransition")}function t(){i()}function r(){clearTimeout(u),n(),u=setTimeout(function(){t()},300)}var u,s=($(o),$(window));e()};
},{"modules/barba":"modules/barba","modules/footer":"modules/footer","modules/menu":"modules/menu","modules/settings":"modules/settings","modules/throttle":"modules/throttle"}],"modules/footer":[function(require,module,exports){
var footer=module.exports={toggleBtn:$(".footer-nav__link"),footerContent:$(".footer-nav__page-content"),init:function(){footer.toggleBtn.on("click",footer.toggleFooter)},toggleFooter:function(o){o.preventDefault(),$("body").hasClass("footer-open")?footer.hideFooter():footer.showFooter()},showFooter:function(){$("body").addClass("footer-open"),footer.footerContent.addClass("open").slideDown(),$("body").animate({scrollTop:$("body")[0].scrollHeight},1e3)},hideFooter:function(){$("body").removeClass("footer-open"),footer.footerContent.removeClass("open").slideUp()},windowClickMenu:function(o){}};
},{}],"modules/ig-module":[function(require,module,exports){
var Instafeed=require("instafeed.js");module.exports=function(e){var a=($(e),new Instafeed({get:"user",userId:"5439801",clientId:"6ed34b4b3be94240810a7111ede3a4f9",accessToken:"5439801.1677ed0.a9079583b03b4f6a8c572e0f25409665"}));a.run()};
},{"instafeed.js":2}],"modules/menu":[function(require,module,exports){
var settings=require("modules/settings"),throttle=require("modules/throttle"),menu=module.exports={hamburger:$("#hamburger"),lastScrollTop:0,init:function(){console.log("menu init"),$(".home-link").on("click",menu.homeLinkClick),$(".menu-link").on("click",menu.menuLinkClick),$(window).on("scroll",menu.winScroll)},homeLinkClick:function(){},menuLinkClick:function(){console.log("menu link clicked")},logoClick:function(e){e.preventDefault(),console.log("logoClick"),$("body").hasClass("menu-open")?menu.hideMenu():$("body").animate({scrollTop:0},1e3)},toggleMenu:function(){$("body").hasClass("menu-open")?menu.hideMenu():menu.showMenu()},toggleSiteNav:function(e){e.preventDefault(),!$(e.currentTarget).parent().hasClass("open")&&$(e.currentTarget).parent().find(".site-nav__page-content").length>0&&($(".site-nav li.open").removeClass("open"),$(e.currentTarget).parent().addClass("open"))},showMenu:function(){$("body").addClass("menu-open"),this.hamburger.addClass("menu-open"),$(window).on("click",menu.windowClickMenu)},hideMenu:function(){$(window).off("click",menu.windowClickMenu),$("body").removeClass("menu-open"),this.hamburger.removeClass("menu-open"),$(".site-nav li.open").removeClass("open")},winScroll:function(e){if($("body").hasClass("scrolling"))return!0;var n=$("body").scrollTop();n>menu.lastScrollTop?$("header").hasClass("hidden")||$("header").addClass("hidden"):$("header").hasClass("hidden")&&$("header").removeClass("hidden"),menu.lastScrollTop=n,"home"!=settings.page&&"project"!=settings.page||($("body").scrollTop()>$(window).height()?$("header").removeClass("hero-menu"):$("header").addClass("hero-menu"))},windowClickMenu:function(e){e.clientX>$(window).width()/2&&menu.hideMenu()}};
